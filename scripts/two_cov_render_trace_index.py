...
SLUG_MAP = {
    ...
    "健保": "national_health",
    "疫情": "pandemic",
    "媒體多元": "media_diversity",
    "平埔正名": "plains_indigenous",
    "校園": "campus",
}

# 議題分組(用於 filter category)
ISSUE_GROUPS = {
    "civil_political": ("公民政治權", ["廢死", "言論自由", "媒體多元", "宗教自由", "良心拒服兵役"]),
    "minority": ("少數族群 / 弱勢", ["原住民族", "平埔正名", "移工", "漁工"]),
    "family_education": ("家庭與教育", ["教育權", "性平教育", "選擇權", "同性婚姻", "校園"]),
    "health_welfare": ("健康與福利", ["兒少自殺", "健康權", "健保", "菸害", "稅務", "長照", "疫情"]),
}
...
DESC_MAP = {
    ...
    "長照": "ICESCR §12 + §10 長照家屬權益 + 失能者人權 + 長照 2.0 政策 + 預算配置",
    "健保": "ICESCR §12 健康權 + 全民健保納保範圍 + 給付項目 + 罕見疾病 + 城鄉醫療差距",
    "疫情": "ICCPR §17 隱私 + §12 行動自由 + ICESCR §12 健康權 / COVID-19 期間防疫措施張力",
    "媒體多元": "ICCPR §19 + GC34 + 媒體所有權集中議題 + NCC 監管 + 公廣集團定位",
    "平埔正名": "ICCPR §1 自決權 + §27 少數族群 + 平埔族正名議題 + 111 憲判 17 號",
    "校園": "ICESCR §13 教育權 + ICCPR §24 兒少 + 校園藥物 / 體罰 / 輔導機制議題",
}
